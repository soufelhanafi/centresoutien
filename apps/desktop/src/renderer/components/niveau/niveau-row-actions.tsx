...
import { MoreHorizontal, SquarePen, Power, RotateCcw } from 'lucide-react';
import {
  Button,
  DropdownMenu,
  DropdownMenuContent,
 ...
 * and "Désactiver". A referenced niveau (any usage count > 0) opens the in-use
 * warning dialog before deactivating; a free one deactivates instantly with a
 * toast. The in-use item is deliberately NOT marked disabled — it remains a
 * working control whose dialog explains the references.
 */
