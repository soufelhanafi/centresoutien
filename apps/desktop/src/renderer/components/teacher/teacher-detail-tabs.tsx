...
/**
 * The four-tab teacher detail surface. Info, Subjects (via `subject.list`,
 * SOU-124), and Rule (via `teacherPayrollRule.*`, SOU-72) are live. Groups is a
 * shell until its domain is wired to the renderer (SOU-48).
 */
