    ...
    return (
      <section className="mx-auto flex w-full max-w-5xl flex-col gap-4">
        ...
        <EmptyState
          ...
          title={query.isError ? t('groups.loadError.title') : t('groups.detail.notFoundTitle')}
          description={query.isError ? t('groups.detail.loadError') : t('groups.detail.notFoundBody')}
          action={
