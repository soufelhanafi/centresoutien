...
import type { OutOfWindowSessionView } from '../../../src/renderer/lib/teacher-availability/availability-recheck-gateway';
...
describe('TeacherAvailabilityRecheckDialog', () => {
  ...
  it('renders nothing when there is nothing to report', () => {
    const { container } = render(
      <TeacherAvailabilityRecheckDialog open sessions={[]} onOpenChange={() => {}} />,
    );
  ...
  it('lists the stranded sessions when open', () => {
    render(
      <TeacherAvailabilityRecheckDialog open sessions={[SESSION]} onOpenChange={() => {}} />,
    );
