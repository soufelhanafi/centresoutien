 ...
 * caller's className) containing a viewport and the children. E2E exercises the
 * real lib under Chromium.
 */
...
export function OverlayScrollbarsComponent({
  ...
  return (
    <div className={className} data-overlayscrollbars="mock" {...props}>
      <div data-overlayscrollbars-viewport="mock">{children}</div>
    </div>
  );
}
