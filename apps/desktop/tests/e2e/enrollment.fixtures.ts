...
> = {
  ...
  ar: {
    ...
    guard: {
      ...
      duplicate: 'هذا الطالب مسجّل بالفعل في هذه المجموعة.',
      crossKind: 'اشتراك الطالب لا يطابق نوع المجموعة (عادي / تحضير الامتحان).',
      subscriptionMissing: 'لا يملك الطالب أي اشتراك نشط يغطي مادة هذه المجموعة.',
    },
  },
};
